...
import {MaticnaListaComponent} from './maticna-lista/maticna-lista.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: "maticna/:id", component: MaticnaListaComponent},
      {path: 'verify-semester/:id', component: VerifySemesterComponent},
